...
export default function tac() {
  return (
    <div className="px-4 py-32">
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from www.babyonboard.com</li>
        <li>Sell, rent or sub-license material from www.babyonboard.com</li>
        <li>Reproduce, duplicate or copy material from www.babyonboard.com</li>
        <li>Redistribute content from www.babyonboard.com</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Baby
        onBoard does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Baby onBoard , its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Baby onBoard shall not be
        ...
        Baby onBoard reserves the right to monitor all Comments and to remove
     ...
     <br />
      ...
      <br />
      <p>
        You hereby grant Baby onBoard a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
      </p>
      <h3 className=" font-bold mb-2 text-xl">Hyperlinking to our Content</h3>
      <br />
      <p>
      ...
      <p>
        ...
        e-mail to Baby onBoard . Please include your name, your organization
      ...
      <p>
        No use of Baby onBoard&#x27;s logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </p>
      <br />
      <h3 className=" font-bold mb-2 text-xl">iFrames</h3>
      <p>
      ...
      <br />
      <h3 className=" font-bold mb-2 text-xl">Content Liability</h3>
      <p>
      ...
      <br />
      <h3 className=" font-bold mb-2 text-xl">Removal of links from our website</h3>
      <p>
      ...
      <br />
      <h3 className=" font-bold mb-2 text-xl">Disclaimer</h3>
      <p>
