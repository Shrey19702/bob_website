...
export default function contactForm() {
  return (
    <div class="container">
      <div class="flex flex-wrap lg:justify-between justify-center ml-8 items-center py-32">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               ...
               <p class="text-base text-body-color leading-relaxed mb-9">
                  We are always open for suggestions and to help in case of any inconvinience, so send us a mail or fill this form and send a message to let us know and we'll handle the rest.
               </p>
