...
export default function products({f_product}) {
  ...
  return(
    <div className='p-96 font-semibold bg-slate-100'>
      Hello
    </div>
  )
  ...
  //           {f_product.breadcrumbs.map((breadcrumb) => (
  ...
  //             <a href={f_product.href} aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">
  //               {f_product.name}
  //             </a>
  //           </li>
  //         </ol>
  ...
  //           <img
  //             src={f_product.image.src}
  //             alt={f_product.image.alt? f_product.image.alt: "no image" }
