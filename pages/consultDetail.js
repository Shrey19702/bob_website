const consultDetail = ()=>{
    return(
        <div className="container">
          <div className="flex flex-wrap lg:justify-between justify-center w-full items-center py-32">

            <div className="w-full lg:w-1/2 xl:w-5/12 px-4 grow">
            ...
            <div className="w-full mt-10 lg:m-0 lg:w-1/2 xl:w-5/12 px-4 grow">
                <div className="max-w-[570px] mb-12 lg:mb-0">
                <h2 className="text-dark mb-6 uppercase font-bold text-[32px] sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET A CONSULTANCY APPOINTMENT
                </h2>
                <p className="text-base text-body-color leading-relaxed mb-9">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque mollitia et aliquam aliquid quasi harum? Illo, facilis officiis unde corrupti accusamus, maiores sed maxime ex quaerat fugiat eius, tempore voluptatibus.
                </p>
