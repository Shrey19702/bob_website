          ...
          <div className="container justify-center mx-auto flex flex-wrap ">
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="max-w-lg mx-auto">
                ...
                {/* link for all blogs */}
                <Link href="/blog">
                  <a className="inline-block w-full sm:w-auto px-7 py-4 text-center font-medium bg-green-500 hover:bg-green-600 text-white rounded transition duration-250">
