  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap  mx-4">
      ...
      <div className="w-full lg:w-1/2 px-4 mb-14 lg:mb-0">
        <img className="block sm:w-9/12" src="https://tailwindui.com/img/ecommerce-images/product-page-01-related-product-01.jpg" alt=""/>
      </div>
      <div className="w-full lg:w-1/2 px-4">
        <div className="max-w-lg mx-auto">
          <div className="mb-12">
            <span className="inline-block px-5 py-2 mr-6 text-sm bg-white rounded-full">Blogs</span>
