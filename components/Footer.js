    ...
    return ( 
      <footer className="text-center lg:text-left bg-gray-100 text-gray-600 h-[30vh]">
        ...
        <div className="flex justify-center items-center lg:justify-start p-6 border-b border-gray-300 h-[5vh]">
          ...
          <div className="flex justify-center">
            <Link href="https://www.facebook.com/">
              <a className="transition mr-6 text-gray-600 hover:text-yellow-500"> 
                <Facebooksvg/>
              </a>
            </Link>
        ...
        <div className="mx-6 text-center md:text-left h-fit">
          <div className="flex flex-row justify-around items-center text-center h-fit flex-wrap w-full px-8">
            ...
            <div className="py-8 h-fit w-1/3 min-w-[320px]">
              ...
              <p>
                Discover Fresh Delights Grocery! <br/> 
            ...
            <div className="py-8 h-fit w-1/3 min-w-[320px]" >
              {/* Useful links */}
              <h6 className="font-semibold mb-4 flex justify-center text-yellow-500 ">Useful links</h6>
            ...
            {/* contact */}
            <div className="py-8 h-fit w-1/3 min-w-[320px]">
              <h6 className="font-semibold mb-4 flex justify-center text-yellow-500 ">Contact</h6>
              <p className="flex items-center justify-center  mb-4">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
                  className="w-4 mr-4 text-green-700" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              ...
              <p className="flex items-center justify-center mb-4">
                <Link href="mailto:babyonboard012@gmail.com">
                  <a className=' flex'>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
                      className="w-4 mr-4 text-green-700" role="img" xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512">
                      <path fill="currentColor"
                        d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z">
                      </path>
                    </svg>
                    Groceries_Store@gmail.com
                  </a>
                </Link>
              </p>
              <p className="flex items-center justify-center  mb-4">
                <Link href="tel:+918058043458">
                  <a className='flex'>
        ...
        <div className="text-center p-2 bg-gray-200 ">
          ...
          <a className="text-gray-600 font-semibold px-1" href="#">Groceries Store</a>
        </div>
